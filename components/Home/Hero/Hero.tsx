...
const Hero = () => {
  return (
    <div className="relative w-full h-[110vh] sm:h-screen bg-[url('/images/bg1.jpg')] bg-cover bg-center">
        <div className="absolute inset-0 flex justify-center flex-col">
            <div className="w-[90%] md:w-[80%] mx-auto itels-center grid grid-cols-1">
                <h1 className='text-white text-3xl md:text-5xl lg:text-6xl mt-6 mb-4 font-bold leading-[2.5rem] md:leading-[3.5rem]'>
                    BIENVENU SUR TAC AU TAC  
                    <br className='mb-4' /> 
                    BUSINESS 
                </h1>
                <p className='text-white text-2xl md:text-4xl lg:text-5xl mt-4 mb-6'>
                ...
                <div>
                    <a href="#_" className="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group">
                        ...
                        <span className="relative">Acheter Maintenant</span>
                    </a>
                </div>
            </div>
        </div>
